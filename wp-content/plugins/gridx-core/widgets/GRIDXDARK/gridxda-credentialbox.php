...
class Elementor_gridx_gridxdacredentialbox_Widget extends \Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section1',
            [
                'label' => esc_html__( 'Dark Credential Box Section', 'gridx-core' ),
    ...
    <div data-aos="zoom-in" class="about-crenditials-box">
            <div class="info-box shadow-box h-full">
                <a class="overlay-link" href="<?php echo esc_url($gridxdacredentialbox_output['boxlink']['url']); ?>"></a>
...
<img src="<?php echo esc_url(wp_get_attachment_image_url($gridxdacredentialbox_output['bgimg']['id'], 'full' ));?>" alt="BG" class="bg-img">
				
<?php endif; } ?>
				
<img src="<?php echo esc_url(wp_get_attachment_image_url($gridxdacredentialbox_output['signimg']['id'], 'full' ));?>" alt="Sign">
                <div class="d-flex align-items-center justify-content-between">
                    <div class="infos">
                        <h4><?php echo esc_html($gridxdacredentialbox_output['heading']); ?></h4>
                        <h1><?php echo esc_html($gridxdacredentialbox_output['title']); ?></h1>
                    </div>
