...
class Elementor_gridx_gridxdaservicecontentbox_Widget extends \Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section1',
            [
                'label' => esc_html__( 'Dark Service Title Section', 'gridx-core' ),
        ...
        $this->start_controls_section(
            'section2',
            [
                'label' => esc_html__( 'Dark Service Content Box Section', 'gridx-core' ),
                'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'          => \Elementor\Controls_Manager::COLOR,
                'selectors'     => [
                    '{{WRAPPER}} .service-content-wrap .service-content-inner .service-item h3'=> 'color: {{VALUE}} !important;',
                ],
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector'      => 
                    '{{WRAPPER}} .service-content-wrap .service-content-inner .service-item h3',
            ]
        );
            ...
            <div class="service-content-inner shadow-box">
                ...
                foreach ($gridxdaservicecontentbox_output['list1'] as $gridxdaservicecontentbox_loop):?>
                    <div class="service-item">
                        <h3><?php echo esc_html($gridxdaservicecontentbox_loop['serheading']); ?></h3>
                        <p><?php echo esc_html($gridxdaservicecontentbox_loop['serdescription']); ?></p>
                    </div>
