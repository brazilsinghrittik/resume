...
class Elementor_gridx_gridxdaexperiencebox_Widget extends \Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section1',
            [
                'label' => esc_html__( 'Dark Experience Box Section', 'gridx-core' ),
...
<img src="<?php echo esc_url(wp_get_attachment_image_url($gridxdaexperiencebox_output['bgimg']['id'], 'full' ));?>" alt="BG" class="bg-img">
				
<?php endif; } ?>
        <h3><?php echo esc_html($gridxdaexperiencebox_output['title']); ?></h3>
        ...
        <ul>
            ...
            <li>
                ...
                <h2><?php echo esc_html($gridxdaexperiencebox_loop['heading']); ?></h2>
