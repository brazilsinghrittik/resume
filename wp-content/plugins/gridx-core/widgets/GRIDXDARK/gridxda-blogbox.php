...
class Elementor_gridx_gridxdablogbox_Widget extends \Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section1',
            [
                'label' => esc_html__( 'Dark Blog Box Section', 'gridx-core' ),
        ...
        <div class="blog-service-profile-wrap d-flex gap-24">
            <div data-aos="zoom-in" class="about-blog-box">
                <div class="info-box shadow-box h-full">
                    <a href="<?php echo esc_url($gridxdablogbox_output['boxlink']['url']); ?>" class="overlay-link"></a>
                    <?php 	if( class_exists( 'ReduxFrameworkPlugin' ) ) { 

    global $gridx_options; 
			if($gridx_options['gridx_color_switcher_options'] == 1) : ?>
				
<img src="<?php echo esc_url(wp_get_attachment_image_url($gridxdablogbox_output['bgimg']['id'], 'full' ));?>" alt="BG" class="bg-img">
				
<?php endif; } ?>
                    <img src="<?php echo esc_url(wp_get_attachment_image_url($gridxdablogbox_output['gfontimg']['id'], 'full' ));?>" alt="GFonts">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="infos">
                            <h4><?php echo esc_html($gridxdablogbox_output['heading']); ?></h4>
                            <h1><?php echo esc_html($gridxdablogbox_output['title']); ?></h1>
                        </div>
